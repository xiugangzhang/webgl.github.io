#### 环境贴图进阶
<p><iframe style="width: 100%; height: 520px; text-align:center;" src="/nehe_webgl/lessons/NeHeWebGL9.html" frameborder="0" width="500" height="500"></iframe></p>
...
void main(void)
{
    ...
    <script>
        ...
        function initTextures() {
            ...
            */
            var images = [
                '../resources/cube/01.bmp',
                '../resources/cube/02.bmp',
                '../resources/cube/03.bmp',
                '../resources/cube/04.bmp',
                '../resources/cube/05.bmp',
                '../resources/cube/06.bmp'
            ];

            //设置图片的纹理地址
            for (var i = 0; i < 6; i++) {
                var createImage = new Image();
                createImage.src = images[i];
                ...
                webgl.bindTexture(webgl.TEXTURE_CUBE_MAP, createTextures[i]);
        ...
        function handleLoadedTexture(textures) {
            ...
            /*for (var i = 0; i < textures.length; i++) {
                console.log(textures.length + ' ' + textures[i].image.src);
            }*/
            ...
            webgl.texImage2D(webgl.TEXTURE_CUBE_MAP_POSITIVE_X, 0, webgl.RGB, webgl.RGB, webgl.UNSIGNED_BYTE, textures[0].image);
            webgl.texImage2D(webgl.TEXTURE_CUBE_MAP_NEGATIVE_X, 0, webgl.RGB, webgl.RGB, webgl.UNSIGNED_BYTE, textures[1].image);
            webgl.texImage2D(webgl.TEXTURE_CUBE_MAP_POSITIVE_Y, 0, webgl.RGB, webgl.RGB, webgl.UNSIGNED_BYTE, textures[2].image);
            webgl.texImage2D(webgl.TEXTURE_CUBE_MAP_NEGATIVE_Y, 0, webgl.RGB, webgl.RGB, webgl.UNSIGNED_BYTE, textures[3].image);
            webgl.texImage2D(webgl.TEXTURE_CUBE_MAP_POSITIVE_Z, 0, webgl.RGB, webgl.RGB, webgl.UNSIGNED_BYTE, textures[4].image);
            webgl.texImage2D(webgl.TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, webgl.RGB, webgl.RGB, webgl.UNSIGNED_BYTE, textures[5].image);
        }
